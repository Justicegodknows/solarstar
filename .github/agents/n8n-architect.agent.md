...
- Generated context root hint: `/home/admin/solarstar`. If this path exists, run workspace commands from there.
...
0. Read `progress.md` at the context root before implementing any code, and update it after your change lands.
